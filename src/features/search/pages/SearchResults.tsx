...
export default function SearchResults() {
  ...
  const pageTitle = debouncedQuery
    ? `Search results for "${debouncedQuery}" | YouTube`
    : "Search | YouTube";
  const pageDescription = debouncedQuery
    ? `Browse search results for "${debouncedQuery}" on YouTube. Find videos, channels, and more.`
    : "Search YouTube for videos, channels, and more. Find content that matches your interests.";
